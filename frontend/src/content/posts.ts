...
export const posts: BlogPost[] = [
  {
    slug: "monte-carlo-futebol",
    title: "Como funciona a simulação Monte Carlo no futebol",
    date: "2026-02-07",
    excerpt: "Entenda como usamos milhares de simulações para calcular as probabilidades de título, Libertadores e rebaixamento no Brasileirão.",
    tags: ["Monte Carlo", "Estatística", "Brasileirão"],
    readTime: 6,
    content: `## O que é Monte Carlo?
...
*As projeções são resultado de modelos estatísticos com fins informativos e educacionais. Não representam garantia de resultado.*`,
  },
  {
    slug: "xg-expected-goals",
    title: "xG explicado: o que é Expected Goals e como usar",
    date: "2026-02-06",
    excerpt: "Expected Goals (xG) é a métrica que revolucionou a análise de futebol. Saiba como funciona e por que um time pode jogar 'bem' e perder.",
    tags: ["xG", "Estatística", "Análise"],
    readTime: 5,
    content: `## O que é xG?
...
*As projeções são resultado de modelos estatísticos com fins informativos e educacionais. Não representam garantia de resultado.*`,
  ...
  {
    slug: "classificacao-brasileirao-2026",
    title: "Classificação do Brasileirão 2026: probabilidades em tempo real",
    date: "2026-02-05",
    excerpt: "Acompanhe a classificação do Brasileirão 2026 com probabilidades de título, Libertadores e rebaixamento atualizadas a cada rodada.",
    tags: ["Brasileirão", "Classificação", "Monte Carlo"],
    readTime: 4,
    content: `## Classificação ao vivo com probabilidades
...
*As projeções são resultado de modelos estatísticos com fins informativos e educacionais. Não representam garantia de resultado.*`,
  ...
  {
    slug: "guia-cartola-fc-2026",
    title: "Guia completo do Cartola FC 2026: como montar o melhor time",
    date: "2026-02-04",
    excerpt: "Tudo o que você precisa saber para mandar bem no Cartola FC 2026: escalação, valorização, MPV, capitão e estratégias avançadas.",
    tags: ["Cartola FC", "Escalação", "Guia"],
    readTime: 8,
    content: `## O básico do Cartola FC
...
*O ScoutDados é uma ferramenta de simulação e estatística. O Cartola FC é marca registrada da Globo.*`,
  },
  {
    slug: "modelo-poisson-previsao-placares",
    title: "Previsão de placares: como funciona nosso modelo Poisson",
    date: "2026-02-03",
    excerpt: "Nosso modelo usa distribuição de Poisson para prever placares. Entenda a matemática por trás e veja como os top 5 placares mais prováveis são calculados.",
    tags: ["Poisson", "Previsão", "Estatística"],
    readTime: 7,
    content: `## Por que Poisson?
